...
internal class Inntektsendringer(
    personident: Personident,
    inntektsendringer: List<Inntektsendring>,
                            ...
                            Db.InntektInn(
                                ...
                                beløp =
                                    when (inntektsperiode.beløp) {
                                        ...
                                        is Beløp.Periodisert ->
                                            Db.Periodisert(inntektsperiode.beløp.ører).also {
