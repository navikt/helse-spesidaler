...
internal class GjeldendeInntekterTest {
    ...
    @Test
    fun `omsluttet ny inntekt gir gammel snute og hale, men ny mage`() =
        databaseTest {
            it.settInn(Daglig(10_00), 1.januar tilÅpen 31.januar)
    ...
    @Test
    fun `håndterer også periodisert inntekt`() =
        databaseTest {
    ...
    @Test
    fun `inntekter med forskjellig oppløsning`() =
        databaseTest {
    ...
    @Test
    fun `inntekter fra ulike kilder`() =
        databaseTest {
    ...
    @Test
    fun `å sette inntekten til 0 kroner er noe annet enn å fjerne inntekten`() =
        databaseTest {
            val orgnummer1 = Inntektskilde("999999999")
            val orgnummer2 = Inntektskilde("111111111")
    ...
    @Test
    fun `flere inntekter fra ulike kilder`() =
        databaseTest {
            val orgnummer1 = Inntektskilde("999999999")
            val orgnummer2 = Inntektskilde("111111111")
    ...
    private fun DataSource.settInn(
        beløp: Beløp,
        åpenPeriode: ÅpenPeriode,
        inntektskilde: Inntektskilde = this@GjeldendeInntekterTest.orgnummer,
    ) {
        Inntektsendringer(
