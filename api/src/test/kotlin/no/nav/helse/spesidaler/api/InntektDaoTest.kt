...
internal class InntektDaoTest {
    ...
    @Test
    fun `overlappende inntekt som starter før perioden`() =
        databaseTest {
    ...
    @Test
    fun `overlappende inntekt som slutter etter perioden`() =
        databaseTest {
            val personident = Personident("fnr")
            val kilde = Inntektskilde("kilde")
    ...
    @Test
    fun `spør om inntekter i et hull`() =
        databaseTest {
            val personident = Personident("fnr")
            val kilde = Inntektskilde("kilde")
    ...
    private fun Db.InntektInn.ut(løpenummer: Long = 1) =
        Db.InntektUt(
    ...
    private fun DataSource.lagrOgHent(
        periode: Periode,
        vararg inntekt: Db.InntektInn,
    ) = connection {
