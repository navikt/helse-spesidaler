...
internal class InntektTableTest {
    @Test
    fun `går ikke å lagre en ugyldig periode`() =
        databaseTest {
            @Language("PostgreSQL")
            val sql = """
    ...
    @Test
    fun `går ikke å lagre et periodisert beløp uten tom`() =
        databaseTest {
            @Language("PostgreSQL")
            val sql = """
            INSERT INTO inntekt (personident, kilde, beløp_ører, beløp_oppløsning, fom, tom) 
    ...
    @Test
    fun `går ikke å legge til en ugyldig oppløsning`() =
        databaseTest {
            @Language("PostgreSQL")
            val sql = """
            INSERT INTO inntekt (personident, kilde, beløp_ører, beløp_oppløsning, fom, tom) 
