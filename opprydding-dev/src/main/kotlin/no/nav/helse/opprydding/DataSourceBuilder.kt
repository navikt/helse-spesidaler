...
internal class DataSourceBuilder(env: Map<String, String>) {
    ...
    private val databaseUsername: String = env.envValue("DATABASE_SPESIDALER_OPPRYDDING_DEV_USERNAME")
    private val databasePassword: String = env.envValue("DATABASE_SPESIDALER_OPPRYDDING_DEV_PASSWORD")
    private val databaseName: String = env.envValue("DATABASE_SPESIDALER_OPPRYDDING_DEV_DATABASE")
